...
final class Tokeniser {
	...
	Token.Directive directivePending = new Token.Directive(); // directive
																// building up
	...
	void createDirectivePending() {
		directivePending.reset();
	}

	void emitDirectivePending() {
		emit(directivePending);
	}
